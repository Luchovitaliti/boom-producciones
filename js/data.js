...
let USERS=[];
const ALL_PAGES=['home','dashboard','boomhero','heroconfig','barra','adminfin','recaudacion','liderpub','publicas','trafic','cm','boom','chat','proveedores','kpi','dev','usuarios','perfil'];
const PAGE_LABELS={home:'Inicio',dashboard:'Dashboard',boomhero:'BOOM HERO',heroconfig:'Puntajes BOOM HERO',barra:'Barra',adminfin:'Administración',recaudacion:'Recaudación',liderpub:'Líder Públicas',publicas:'Públicas',trafic:'Trafic',cm:'CM',boom:'BOOM General',chat:'Chat interno',proveedores:'Proveedores',kpi:'Reportes y KPIs',dev:'🛠 Dev',usuarios:'Usuarios',perfil:'Mi perfil'};
const PAGE_ICONS={home:'🏠',dashboard:'📊',boomhero:'⚡',heroconfig:'🏆',barra:'🍺',adminfin:'📋',recaudacion:'💵',liderpub:'⭐',publicas:'📸',trafic:'🚐',cm:'📅',boom:'💡',chat:'💬',proveedores:'🤝',kpi:'📈',dev:'🛠',usuarios:'👥',perfil:'👤'};
const PAGE_SECTIONS={home:'Mi cuenta',dashboard:'Admin',boomhero:'Comunicación',heroconfig:'Admin',barra:'Módulos',adminfin:'Módulos',recaudacion:'Módulos',liderpub:'Módulos',publicas:'Módulos',trafic:'Módulos',cm:'Comunicación',boom:'Comunicación',chat:'Comunicación',proveedores:'Admin',kpi:'Admin',dev:'Admin',usuarios:'Admin',perfil:'Mi cuenta'};
